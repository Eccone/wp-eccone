...
<article id="post-<?php the_ID(); ?>" <?php post_class($post_class); ?>>
	<div class="<?echo $panel;?>">
		<header class="entry-header <?echo $panel_heading;?>">
			<?php if (is_single()) {
		...
		<div class="clearfix <?php echo $panel_body;?>">
			...
			<div class="entry-content">
				<a href="#em-booking" class="btn btn-primary">S'inscrire</a>
				<?php
...
function eccone_event_clear_js() { ?>
<script type="text/javascript">
	jQuery(document).ready( function($){
		$(this).find('.entry-content br[style*="clear:both"]').remove();
	});
</script>
<?php }
add_action('wp_footer', 'eccone_event_clear_js'); ?>
